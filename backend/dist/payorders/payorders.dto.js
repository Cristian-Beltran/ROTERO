...
exports.updatePayorderDto = exports.createPayorderDto = void 0;
const openapi = require("@nestjs/swagger");
const mapped_types_1 = require("@nestjs/mapped-types");
const class_validator_1 = require("class-validator");
class createPayorderDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { detail: { required: true, type: () => String }, operatorId: { required: true, type: () => Number }, typePayorderId: { required: true, type: () => Number } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", Number)
], createPayorderDto.prototype, "typePayorderId", void 0);
